...
```sh
curl https://raw.githubusercontent.com/lil5/lazypodman/main/scripts/install_update_linux.sh | bash
```
...
```
git clone https://github.com/lil5/lazypodman.git
cd lazypodman
go install
```

...
ARG VERSION
LABEL \
    org.opencontainers.image.authors="li@last.nl" \
    org.opencontainers.image.created=$BUILD_DATE \
    org.opencontainers.image.version=$VERSION \
    org.opencontainers.image.revision=$VCS_REF \
    org.opencontainers.image.url="https://github.com/lil5/lazypodman" \
    org.opencontainers.image.documentation="https://github.com/lil5/lazypodman" \
    org.opencontainers.image.source="https://github.com/lil5/lazypodman" \
...
COPY --from=builder /tmp/gobuild/lazydocker /bin/lazypodman
